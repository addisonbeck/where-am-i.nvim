...
A Neovim UI component designed to keep track of where the heck you are right now.
...
`where-am-i.nvim` exposes all of it's functionality through commands. These
can be applied to keybindings in your Neovim configuration if desired.

| Command | Description |
| ---------- | ----------- |
| `:WhereAmI please_tell_me` | Shows an ephemeral floating window displaying the current filename |
| `:WhereAmI next_buffer`| Swaps the buffer in your active window to your next buffer and displays the name of the newly focused file |
| `:WhereAmI previous_buffer` | Swaps the buffer in your active window to the your previous buffer and displays the name of the newly focused file |
